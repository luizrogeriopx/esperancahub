          ...
          {lideres.map((lider) => (
            ...
            >
              <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                >
                  <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 1 0-4 4v2" />
                  <circle cx="12" cy="7" r="4" />
                </svg>
              </<parameter name="file_path">src/routes/suporte.tsx</parameter>
<parameter name="content">import { createFileRoute } from "@tanstack/react-router";
